...
public class ReceptionistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout = findViewById(R.id.btn_receptionist_logout);
        ...
        adapter = new TaskAdapter(options, Worker.RECEPTIONIST);

        RecyclerView recyclerView = findViewById(R.id.rv_receptionist);
        ...
        adapter.setOnItemClickListener((DocumentSnapshot documentSnapshot, int position) -> {
            ...
            if(task.getWorkerId()==null) {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .show();
            } else if(!task.getWorkerId().equals(userId) && !task.getWorkerId().isEmpty()) {
        ...
        logout.setOnClickListener((View v) -> {
            ...
            Intent intent = new Intent(ReceptionistActivity.this, LoginActivity.class);
