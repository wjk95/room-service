...
public class ConsiergeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consierge);

        String userId = mUser.getUid();
        logout = findViewById(R.id.btn_consierge_logout);
        ...
        adapter = new TaskAdapter(options, Worker.CONSIERGE);

        RecyclerView recyclerView = findViewById(R.id.rv_consierge);
        ...
        logout.setOnClickListener((View v) -> {
            ...
            Intent intent = new Intent(ConsiergeActivity.this, LoginActivity.class);
